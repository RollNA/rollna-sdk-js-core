...
async function test_formatRollInERC20Input() {
    let input = await index.formatRollInERC20Input("0x777aDd3378b999235cce77F71292dAc1E8095FFC", 1337, "0xffffffffffffff", "0x37e6C8116B9f735b469B64Ee59b6464025Db6C31", "0x777aDd3378b999235cce77F71292dAc1E8095FFC", 5000000, 100000000, "0x777aDd3378b999235cce77F71292dAc1E8095FFC", 500584000000000);
    if (input != ErrorType_1.ErrorType.FormatInputFailed) {
        let web3 = new Web3.Web3("ws://43.134.20.65:8346");
        web3.eth.accounts.wallet.add('0x0a4eb679dc5fcf150796fca0d0ebdf747ecf4bede66de4f5a7dd01042982f53f');
        let res = await web3.eth.sendTransaction(input);
...
async function test_le_formatRollInERC20Input() {
    let input = await index.formatRollInERC20Input("0x777aDd3378b999235cce77F71292dAc1E8095FFC", 1338, "0xfffffffffff", "0x57a3e28f18e2Dd24B648982836aEC4d618d3494F", "0x777aDd3378b999235cce77F71292dAc1E8095FFC", 500000, 15000000000, "0x777aDd3378b999235cce77F71292dAc1E8095FFC", 7587600000000000);
    if (input != ErrorType_1.ErrorType.FormatInputFailed) {
        let web3 = new Web3.Web3("ws://43.134.20.65:8646");
        web3.eth.accounts.wallet.add('0x0a4eb679dc5fcf150796fca0d0ebdf747ecf4bede66de4f5a7dd01042982f53f');
        let res = await web3.eth.sendTransaction(input);
...
test_le_formatRollOutERC20Input();
